            ...
            controls=[
                ...
                ft.Row(
                    ...
                    controls=[
                        ...
                        ft.Text(self.data["title"], size=16, weight=ft.FontWeight.BOLD, color=ft.Colors.WHITE),
                        ft.Text(self.data["display_date"], size=10, color=ft.Colors.GREY_400),
                    ...
                    controls=[
                        ...
                        ft.Text(
                            spans=[
                                ...
                                ft.TextSpan(f"${self.data['expenses']:,.2f}", ft.TextStyle(weight=ft.FontWeight.BOLD,color=ft.Colors.RED_ACCENT_400))
                            ],
                            size=14,
                    ...
                    controls=[
                        ft.Text(    
                            spans=[
                                ...
                                ft.TextSpan(f"{prefix} ${abs(self.data['balance']):,.2f}", ft.TextStyle(weight=ft.FontWeight.BOLD,color="#ffd900"))
                            ],
                            size=14,
